...
import com.hc.gulimall.search.feign.ProductFeignService;
import com.hc.gulimall.search.service.MallSearchService;
import com.hc.gulimall.search.vo.AttrResponseVo;
import com.hc.gulimall.search.vo.SearchParam;
import com.hc.gulimall.search.vo.SearchResult;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    /**
     * 构架结果数据
     * 模糊匹配,过滤(按照属性,分类,品牌，价格区间，库存)，完成排序分页高亮聚合分析功能
     *
     * @param param
     * @return
     */
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            param.getAttrs().forEach(item -> {
                ...
                boolQuery.must(QueryBuilders.termQuery("attrs.attValue", attrValues));
        ...
        //1.1 品牌的子聚合-品牌名聚合
        brand_agg.subAggregation(AggregationBuilders.terms("brand_name_agg").field("breandName").size(1));
        //1.2 品牌的子聚合-品牌图片聚合
        ...
        SearchRequest searchRequest = new SearchRequest(new String[]{EsConstant.PRODUCT_INDE}, searchSourceBuilder);
